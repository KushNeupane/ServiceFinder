USE [FinderDB]
GO
/****** Object:  StoredProcedure [dbo].[SpGetAnswersByServiceItemIdSel]    Script Date: 7/5/2019 12:29:57 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[SpGetAnswersByServiceItemIdSel] @ServiceItemId INT
AS
BEGIN

...
using ServiceFinder.FrontEnd.Extension;
using ServiceFinder.FrontEnd.ViewModel;
using System;
using System.Reflection;

namespace ServiceFinder.FrontEnd.Context
{
    public class ServiceFinderFrontendContext : IdentityDbContext<ApplicationUserModel>
    {
        public ServiceFinderFrontendContext(DbContextOptions<ServiceFinderFrontendContext> options) : base(options)
        { }
       ...
       // public DbQuery<ServicesByCategoryAndUserNameViewModel> getServicesAndUserByCategory { get; set; }
        public DbQuery<IQuestionAndAnswerViewModel> getQuestionsByServiceItemId { get; set; }

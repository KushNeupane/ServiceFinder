...
{
    public class ServiceFinderDbContext : IdentityDbContext<ApplicationUserModel>
    {
        public ServiceFinderDbContext(DbContextOptions<ServiceFinderDbContext> options) : base(options)
        { }

        public virtual DbSet<ICategoryModel> categories { get; set; }
        public virtual DbSet<IServiceItemModel> serviceItems { get; set; }
        public virtual DbSet<ApplicationUserModel> applicationUsers { get; set; }
        public virtual DbSet<IServiceItemImageModel> serviceItemImages { get; set; }
        public DbQuery<ICategoryAndServiceItemViewModel> CategoryAndServiceItemViewModel { get; set; }
        public virtual DbSet<IServiceReviewModel> serviceReview { get; set; }
        public virtual DbSet<ICityModel> city { get; set; }
        //public virtual DbSet<Question> question { get; set; }
        //public virtual DbSet<Answer> answer { get; set; }
        public virtual DbSet<ISubscriberModel> subscriber { get; set; }
        public virtual DbSet<IServiceItemViewLogModel> ServiceItemViewLogModel { get; set; }
